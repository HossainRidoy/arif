...
const About = () => {
    ...
    return (
        <section id="about" className="padding-top-buttom-100">
            <div className="container">
                <h1 className="text-center padding-bottom-100 text-black">আমাদের সর্ম্পক</h1>
                <p className="font-size-20 text-black text-center">
